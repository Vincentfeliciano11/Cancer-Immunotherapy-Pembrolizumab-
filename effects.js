(()=>{
  ...
  restored.onload=()=>{
    ...
    initFirstPageDNA();
    const comicFix=document.createElement('script');comicFix.src='comic-responsive-fix.js?v=20260821-1';document.head.appendChild(comicFix);
  };
  restored.onerror=()=>{initFirstPageDNA();const comicFix=document.createElement('script');comicFix.src='comic-responsive-fix.js?v=20260821-1';document.head.appendChild(comicFix);};document.head.appendChild(restored);
})();